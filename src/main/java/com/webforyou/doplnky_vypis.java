...
@WebServlet(name = "doplnky_vypis")
public class doplnky_vypis extends HttpServlet {
    Connection con = null;
    ...
    private void vypisVsetko(PrintWriter out) {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM inzerat INNER JOIN kategorie ON inzerat.idKategorie = kategorie.idKategorie WHERE Nazov_kategorie = 'Doplnky' ORDER BY idProduktu DESC");
