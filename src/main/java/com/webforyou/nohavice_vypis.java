...
@WebServlet(name = "nohavice_vypis")
public class nohavice_vypis extends HttpServlet {
    Connection con = null;
    ...
    private void vypisVsetko(PrintWriter out) {
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM inzerat INNER JOIN kategorie ON inzerat.idKategorie = kategorie.idKategorie WHERE Nazov_kategorie = 'Nohavice' ORDER BY idProduktu DESC");
