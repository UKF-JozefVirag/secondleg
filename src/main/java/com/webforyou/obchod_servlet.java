...
@WebServlet(name = "obchod_servlet")
public class obchod_servlet extends HttpServlet {
    Connection con = null;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(operacia.equals("vymazanie")){
            vymazPolozku(out, request.getParameter("idProduktu"));
        }

        if(operacia.equals("zobrazMikiny")){

        }
        if(operacia.equals("zobrazTricka")){

        }
        if(operacia.equals("zobrazBundy")){

        }
        if(operacia.equals("zobrazSukne")){

        }
        if(operacia.equals("zobrazSaty")){

        }
        if(operacia.equals("zobrazNohavice")){

        }
        if(operacia.equals("zobrazTopanky")){

        }
        if(operacia.equals("zobrazDoplnky")){

        }
        if(operacia.equals("zobrazCiapky")){

        }
    }

    private void vymazPolozku(PrintWriter out, String idProduktu) {
    }

    private void vypisVsetko(PrintWriter out) {
        try {
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT * FROM inzerat INNER JOIN kategorie ON inzerat.idKategorie = kategorie.idKategorie ORDER BY idProduktu DESC");
    ...
    private void vypisFiltre(PrintWriter out) {
        ...
        out.println("<button type='hidden' name='operacia' value='zobrazVsetko' class='nav-link' id='btn-nav'>všetko</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazMikiny' class='nav-link' id='btn-nav'>mikiny</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazTricka' class='nav-link' id='btn-nav'>tričká</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazBundy' class='nav-link' id='btn-nav'>bundy</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazSukne' class='nav-link' id='btn-nav'>sukne</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazSaty' class='nav-link' id='btn-nav'>šaty</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazNohavice' class='nav-link' id='btn-nav'>nohavice</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazTopanky' class='nav-link' id='btn-nav'>topánky</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazDoplnky' class='nav-link' id='btn-nav'>doplnky</button>");
        out.println("</li>");
        out.println("<li class='nav-item'>");
        out.println("<button type='hidden' name='operacia' value='zobrazCiapky' class='nav-link' id='btn-nav'>čiapky</button>");
        out.println("</li>");
        out.println("</ul>");
    }
